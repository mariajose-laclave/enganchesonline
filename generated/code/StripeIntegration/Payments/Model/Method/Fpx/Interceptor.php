...
class Interceptor extends \StripeIntegration\Payments\Model\Method\Fpx implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    {
        $this->___init();
        parent::__construct($request, $urlBuilder, $storeManager, $context, $registry, $extensionFactory, $customAttributeFactory, $paymentData, $scopeConfig, $config, $helper, $addressHelper, $api, $logger, $checkoutHelper, $resource, $resourceCollection, $data);
    }
