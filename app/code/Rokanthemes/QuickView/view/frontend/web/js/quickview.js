...
define([
    ...
    $.widget('mage.productQuickview', {
		...
		createWindow: function()
		{
			...
			$(qWindow).html('<div class="quick-view-pop-up"><div id="quickview-header"><a href="javascript:void(0)" id="quickview-close">close</a></div><div class="quick-view-content" id="quickview-content"></div></div>');
			$('body').append(qWindow);
